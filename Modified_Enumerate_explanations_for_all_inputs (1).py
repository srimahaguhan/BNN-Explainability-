    ...
    while True:     
        ...
        try:
            ...
            for maxsat_model in rc2.enumerate():
                ...
                all_explanations.append(value_exp) ''' accumulate each potential value_exp in this
            ...
            Max_SAT_time =  end_MaxSAT_time - start_MaxSAT__time
